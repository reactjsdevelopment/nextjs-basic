...
const SignUp = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-800"> {/* Background color for the entire page */}
      <Head>
      ...
      <main className="flex-grow flex flex-col items-center justify-center py-10">
        <div className="bg-gray-900 border border-gray-600 rounded-lg shadow-lg p-8 w-full max-w-md"> {/* Container for the form */}
